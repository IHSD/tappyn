...
<?php if(!is_null($submission->text) && $submission->text != ''): ?>
    <p style='text-align:left;margin:auto;width:600px'><strong>Description Line 1:</strong> <?php echo $submission->text; ?></p><br>
<?php endif; ?>
<?php if(!is_null($submission->link_explanation) && $submission->link_explanation != ''): ?>
    <p style='text-align:left;margin:auto;width:600px'><strong>Description Line 2 :</strong> <?php echo $submission->link_explanation; ?></p><br>
<?php endif; ?>
