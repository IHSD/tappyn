...
<p>To collect your payment, head to your <?php echo anchor('analytics/click?'.http_build_query($query_string), 'dashboard'); ?> and just click claim! If you haven't yet,
