...
$config['email_program']['contest_closing']['from']         = 'austin@<domain_name>.com';
...
$config['email_program']['winner_announced']['from']         = 'austin@<domain_name>.com';
...
$config['email_program']['mailing_list_conf']['from']         = 'austin@<domain_name>.com';
...
$config['email_program']['post_contest_package']['from']            = 'alek@<domain_name>.com';
...
$config['email_program']['sign_up_conf']['from']         = 'austin@<domain_name>.com';
...
$config['email_program']['contest_completed']['from']         = 'alek@<domain_name>.com';
...
$config['email_program']['submission_chosen']['from']         = 'austin@<domain_name>.com';
...
$config['email_program']['company_sign_up_conf']['from']         = 'alek@<domain_name>.com';
...
$config['email_program']['contest_receipt']['from']         = 'alek@<domain_name>.com';
...
$config['email_program']['payout_receipt']['from']         = 'austin@<domain_name>.com';
...
$config['email_program']['contact_conf']['from']         = 'squad@<domain_name>.com';
...
$config['email_program']['ab_test']['from']         = 'squad@<domain_name>.com';
...
$config['email_program']['pending_purchase']['from']         = 'squad@<domain_name>.com';
