...
$config['email_program']['contest_closing']['from']         = 'austin@fabel.us';
...
$config['email_program']['mailing_list_conf']['from']         = 'austin@fabel.us';
...
$config['email_program']['sign_up_conf']['from']         = 'austin@fabel.us';
...
$config['email_program']['contest_completed']['from']         = 'alek@fabel.us';
...
$config['email_program']['company_sign_up_conf']['from']         = 'alek@fabel.us';
...
$config['email_program']['contest_receipt']['from']         = 'alek@fabel.us';
...
$config['email_program']['payout_receipt']['from']         = 'austin@fabel.us';
...
$config['email_program']['contact_conf']['from']         = 'squad@fabel.us';
...
$config['email_program']['ab_test']['from']         = 'squad@fabel.us';
...
$config['email_program']['pending_purchase']['from']         = 'squad@fabel.us';
