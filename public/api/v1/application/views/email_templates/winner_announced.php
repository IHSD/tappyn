...
<p style='text-align:left;margin:auto;width:600px'>Check out your message's Click Through Rate and all of the purchased messages <?php echo anchor('api/v1/analytics/click?' . http_build_query($query_string), 'here'); ?>.</p>
<br>
<?php $query_string['redirect'] = 'guide';?>
<p style='text-align:left;margin:auto;width:600px'>Wondering why your message wasn't purchased? Take a look at our creative guide to learn more about what makes a great message <?php echo anchor('api/v1/analytics/click?' . http_build_query($query_string), 'here'); ?>.</p>
<br>
